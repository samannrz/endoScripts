...
fn_treat_3 = np.array(b3['FF-NB Treat'])[:-1]
fn_treat_4 = np.array(b4['FF-NB Treat'])[:-1]
fn_treat_5 = np.array(b5['FF-NB Treat'])[:-1]

fn_treat_6 = np.array(b6['FF-NB Treat'])[:-1]
fn_treat_7 = np.array(b7['FF-NB Treat'])[:-1]
fn_treat_8 = np.array(b8['FF-NB Treat'])[:-1]

fn_treat_9 = np.array(b9['FF-NB Treat'])[:-1]
fn_treat_10 = np.array(b10['FF-NB Treat'])[:-1]
fn_treat_11 = np.array(b11['FF-NB Treat'])[:-1]
...
fn_check_3 = np.array(b3['FF-NB Check'])[:-1]
fn_check_4 = np.array(b4['FF-NB Check'])[:-1]
fn_check_5 = np.array(b5['FF-NB Check'])[:-1]

fn_check_6 = np.array(b6['FF-NB Check'])[:-1]
fn_check_7 = np.array(b7['FF-NB Check'])[:-1]
fn_check_8 = np.array(b8['FF-NB Check'])[:-1]

fn_check_9 = np.array(b9['FF-NB Check'])[:-1]
fn_check_10 = np.array(b10['FF-NB Check'])[:-1]
fn_check_11 = np.array(b11['FF-NB Check'])[:-1]
...
# t_stat, p_val = stats.ttest_ind(fn_check_345, fn_check_91011)
...
print("p-value = " + str(p_val))
#########
fn_merge_3 = np.array(b3['FF-NB Merge'])[:-1]
fn_merge_4 = np.array(b4['FF-NB Merge'])[:-1]
fn_merge_5 = np.array(b5['FF-NB Merge'])[:-1]

fn_merge_6 = np.array(b6['FF-NB Merge'])[:-1]
fn_merge_7 = np.array(b7['FF-NB Merge'])[:-1]
fn_merge_8 = np.array(b8['FF-NB Merge'])[:-1]

fn_merge_9 = np.array(b9['FF-NB Merge'])[:-1]
fn_merge_10 = np.array(b10['FF-NB Merge'])[:-1]
fn_merge_11 = np.array(b11['FF-NB Merge'])[:-1]
