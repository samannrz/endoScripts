...
for j in range(math.ceil(lenimg / batch_size)):
    ...
    for i in range(j * batch_size, (j + 1) * batch_size):
        ...
        im3.paste(image_overlayed_F, (0, hh + 2 * space_height + 2*HEIGHT - 100))
        im3.paste(image_overlayed_ER, (WIDTH + 10, hh + 2 * space_height + 2*HEIGHT - 100))
        im3.paste(image_overlayed_EB, (2 * WIDTH + 20, hh + 2 * space_height + 2*HEIGHT - 100))
